...
## Foveal Surface Growing - FSG1, FSG2 & FSG3 (opt-in experiment)
...
active frontier policy that selects and stops its own fixations; no registration,
policy comparison, meshing or multi-object switching is enabled yet.
