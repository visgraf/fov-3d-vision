...
active frontier policy that selects and stops its own fixations, and Increment 4
the paired efficiency comparison against a fixed scan. Increments 1-4 are closed.
No registration, meshing, multi-object switching, head motion or vergence control
is enabled.
