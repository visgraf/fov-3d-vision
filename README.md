...
## Foveal Surface Growing - FSG1 & FSG2 (opt-in experiment)
...
Increment 2 adds two-patch accumulation into that fixed map; no surface-growing
policy, frontier selection or registration is enabled yet.
