...
| D4 | The run to saturation (coverage-first, `full`, 500 fixations, read at checkpoints) and, on its record, a second look as the test: repeatability of bad looks, agreement, mean / median / consensus fusion (`second_look.py`); coverage-first continues as least-looked once the cap is covered | **written** 2026-09-18 — `belief.py`, `active_loop.py`, `active_eval.py`, `second_look.py`, `docs/d4-long-run.md`; D22 closes D2; not run yet |
