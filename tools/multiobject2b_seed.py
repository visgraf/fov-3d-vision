"""Pure evidence extraction and prescribed seed selection for MultiObject-2b."""
...
def self_test() -> None:
    ...
    print("[multiobject2b-seed] PASS parent_selected_object=true valid_depth_only=true occupied_cell_mean=true")
